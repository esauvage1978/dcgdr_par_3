...
class MailerManager extends AbstractManager
{
    ...
    {
        if (array_key_exists('actionValiderCOTECH', $data)) {
            $this->setUsers($data['actionValiderCOTECH']);
        }
        if (array_key_exists('actionValiderCODIR', $data)) {
            $this->setUsers($data['actionValiderCODIR']);
        }
